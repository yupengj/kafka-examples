...
public class Consumer {
	public static void main(String[] args) {
		...
		p.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaProperties.KAFKA_SERVER_URL + ":" + KafkaProperties.KAFKA_SERVER_PORT);
		...
		kafkaConsumer.subscribe(Collections.singletonList(KafkaProperties.TOPIC));
		while (true) {
